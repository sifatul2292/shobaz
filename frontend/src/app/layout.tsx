...
'https://server.shobaz.com/lWhoor22RMay68n/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        <noscript>
          <iframe
            src="https://server.shobaz.com/lWhoor22RMay68n/ns.html?id=GTM-KW6CXCJK"
            height="0"
            width="0"

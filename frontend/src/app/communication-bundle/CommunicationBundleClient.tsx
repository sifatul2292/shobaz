...
const BOOKS = [
  {
    ...
    titleShort: 'Influence',
    tagline: 'মানুষকে প্রভাবিত করার ৬টি সার্বজনীন নীতি',
    author: 'Robert B. Cialdini', authorShort: 'R. Cialdini',
    pages: 248, salePrice: 459, discountAmount: 170, discountPct: 37,
    badge: '5M+ Copies', top: '5M+ Copies Sold',
    color: '#1B3D6B', dark: false, stock: 10, popular: true,
  },
  {
    slug: 'the-48-laws-of-power',
    title: 'The 48 Laws of Power',
    titleShort: 'The 48 Laws of Power',
    tagline: 'ইতিহাসের সেরা কৌশলীদের শক্তির নিয়ম',
    author: 'Robert Greene', authorShort: 'R. Greene',
    pages: 624, salePrice: 882, discountAmount: 383, discountPct: 43,
    badge: 'International', top: 'International Bestseller',
  ...
  },
  {
    ...
    author: 'Dale Carnegie', authorShort: 'D. Carnegie',
    pages: 240, salePrice: 450, discountAmount: 165, discountPct: 37,
    badge: '30M+ Copies', top: '30M+ Copies Sold',
    color: '#F5F0E8', dark: true, stock: 12, popular: false,
  },
  {
    slug: 'never-split-the-difference',
    title: 'Never Split the Difference',
    titleShort: 'Never Split the Difference',
    tagline: 'FBI-র negotiation কৌশল দৈনন্দিন জীবনে',
    author: 'Chris Voss', authorShort: 'C. Voss',
    pages: 240, salePrice: 450, discountAmount: 165, discountPct: 37,
    badge: 'FBI Tactics', top: 'FBI Negotiator',
    color: '#F5C518', dark: true, stock: 9, popular: false,
  },
  {
    slug: 'crucial-conversations',
    title: 'Crucial Conversations',
    titleShort: 'Crucial Conversations',
    tagline: 'কঠিন কথোপকথনে জিতে যাওয়ার উপায়',
    author: 'Kerry Patterson et al.', authorShort: 'K. Patterson',
    pages: 316, salePrice: 528, discountAmount: 204, discountPct: 39,
    badge: 'Top Rated', top: 'Top Rated',
    color: '#C41E3A', dark: false, stock: 11, popular: false,
  },
];
...
export default function CommunicationBundleClient() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.fbq) {
      window.fbq('track', 'ViewContent', { content_name: 'Communication Bundle', content_ids: BOOKS.map((b) => b.slug), content_type: 'product_group' });
    }
  }, []);
          ...
          <div className="fb-container">
            <div ref={r4} style={fadeStyle}>
              <div className="fb-section-head">
                ...
                <h2 className="fb-section-title">দুনিয়ার সবচেয়ে প্রভাবশালী মানুষদের পড়া ৫টি must-read Communication বই এখন এক বান্ডেলে</h2>
                <p className="fb-section-sub">প্রতিটি বই আন্তর্জাতিক বেস্টসেলার ও বিশ্বজুড়ে লক্ষ লক্ষ মানুষের জীবন বদলে দিয়েছে।</p>
              </div>
          ...
          <div className="fb-container">
            <div ref={r6} style={fadeStyle}>
              <div className="fb-section-head">
                ...
                <h2 className="fb-section-title">৫টি বই একসাথে পাচ্ছেন ৪৩% ছাড়ে</h2>
